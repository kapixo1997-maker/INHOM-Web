...
export default function PropertyInfo({ propiedad }: Props) {
  return (
    <div>
      <Link
        href="/"
        className="mb-6 inline-flex items-center gap-2 font-semibold text-[#17495B] transition hover:gap-3 hover:underline"
      >
        <ArrowLeft size={20} />
      ...
      <div className="mt-8 grid grid-cols-2 gap-4">
          ...
          <>
            <div className="rounded-xl bg-gray-100 p-4">
              ...
              <p className="flex items-center gap-2 text-xl font-semibold">
                <BedDouble size={22} className="text-[#17495B]" />
            ...
            <div className="rounded-xl bg-gray-100 p-4">
              ...
              <p className="flex items-center gap-2 text-xl font-semibold">
                <Bath size={22} className="text-[#17495B]" />
            ...
            <div className="rounded-xl bg-gray-100 p-4">
              ...
              <p className="flex items-center gap-2 text-xl font-semibold">
                <Car size={22} className="text-[#17495B]" />
            ...
            <div className="rounded-xl bg-gray-100 p-4">
              ...
              <p className="flex items-center gap-2 text-xl font-semibold">
                <House size={22} className="text-[#17495B]" />
        ...
        <div className="rounded-xl bg-gray-100 p-4">
          ...
          <p className="flex items-center gap-2 text-xl font-semibold">
            <Ruler size={22} className="text-[#17495B]" />
        ...
        <div className="rounded-xl bg-gray-100 p-4">
          ...
          <p className="flex items-center gap-2 text-xl font-semibold">
            <MapPin size={22} className="text-[#17495B]" />
            {propiedad.ubicacion}
          </p>
        </div>
  ...
  <div className="mt-10">
    ...
    <a
      ...
      className="inline-flex items-center gap-2 rounded-xl bg-[#17495B] px-6 py-4 font-semibold text-white transition hover:bg-[#123847]"
    >
      🗺 Ver en Google Maps
    </a>
  </div>
        ...
        <div className="mt-10">
          ...
          <div className="flex flex-wrap gap-3">
            {propiedad.amenidades.map((item) => (
              <span
                key={item}
                className="rounded-full bg-[#17495B]/10 px-4 py-2 text-[#17495B] font-medium"
              >
                ✓ {item}
              </span>
            ))}
      ...
      <WhatsAppCard nombre={propiedad.nombre} />
    </div>
  );
} 